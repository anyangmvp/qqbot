...
if (config.plugins && config.plugins.allow && Array.isArray(config.plugins.allow)) {
    ...
    if (index !== -1) {
        ...
        console.log('  - Deleted qqbot from plugins.allow array');
    }
}
